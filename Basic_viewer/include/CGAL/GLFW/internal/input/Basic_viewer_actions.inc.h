...
void Basic_viewer::register_clipping_plane_actions(internal::Action_registry& registry) {
  ...
  registry.register_action(
    ...
    [](internal::Event_context& ctx) {
      ...
      ctx.viewer.clipping_plane_.translation(
        static_cast<float>(e.yoffset) * CGAL_GLFW_CLIPPING_PLANE_NORMAL_TRANSLATION_SPEED);
      return true; // need to redraw
    });
  ...
  registry.register_action(
    ...
    [](internal::Event_context& ctx) { 
      ctx.viewer.toggle_draw_clipping_plane();
      return true; // need to redraw
    });
...
CGAL_INLINE_FUNCTION
void Basic_viewer::register_application_actions(internal::Action_registry& registry) {
...
CGAL_INLINE_FUNCTION
void Basic_viewer::register_window_actions(internal::Action_registry& registry) {
  ...
  registry.register_action(
    ...
    [](internal::Event_context& ctx) { 
      ctx.viewer.make_screenshot("./screenshot.png");
      return false; // don't need to redraw
    }
  );
}
...
CGAL_INLINE_FUNCTION
void Basic_viewer::register_animation_actions(internal::Action_registry& registry) {
...
CGAL_INLINE_FUNCTION
void Basic_viewer::register_camera_actions(internal::Action_registry& registry) {
  ...
  registry.register_action(
    ...
    [](internal::Event_context& ctx) {
      ctx.viewer.camera_.align_to_plane(ctx.viewer.clipping_plane_.normal());
      return true; // need to redraw
    });
...
CGAL_INLINE_FUNCTION
void Basic_viewer::register_scene_actions(internal::Action_registry& registry) {
  ...
  registry.register_action(
    ...
    [](internal::Event_context& ctx) { 
      ctx.viewer.inc_size_vertex(ctx.dt); 
      return true; // need to redraw
    }
  );
  ...
  registry.register_action(
    ...
    "Increase edge size",
    [](internal::Event_context& ctx) { 
      ctx.viewer.inc_size_edge(ctx.dt); 
      return true; // need to redraw
    }
  );
...
CGAL_INLINE_FUNCTION
void Basic_viewer::register_light_actions(internal::Action_registry& registry) {
  ...
  registry.register_action(
    ...
    [](internal::Event_context& ctx) { 
      ctx.viewer.inc_light_all(ctx.dt); 
      return true; // need to redraw
    }
  );
  ...
  registry.register_action(
    ...
    [](internal::Event_context& ctx) { 
      ctx.viewer.inc_red_comp(ctx.dt); 
      return true; // need to redraw
    }
  );
  ...
  registry.register_action(
    ...
    [](internal::Event_context& ctx) { 
      ctx.viewer.inc_green_comp(ctx.dt); 
      return true; // need to redraw
    }
  );
  ...
  registry.register_action(
    ...
    [](internal::Event_context& ctx) { 
      ctx.viewer.inc_blue_comp(ctx.dt); 
      return true; // need to redraw
    }
  );
