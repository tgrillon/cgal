...
if(BRANCH_BUILD)
  ...
  set(CGAL_BASIC_VIEWER_PACKAGE_DIR ${CGAL_ROOT}/Basic_viewer)
...
#  message("packages_dirs: ${packages_dirs}")
  ...
  set(CGAL_BASIC_VIEWER_PACKAGE_DIR ${CGAL_ROOT})
...
if (CGAL_GLFW_FOUND AND NOT TARGET CGAL::CGAL_Basic_viewer_GLFW)
